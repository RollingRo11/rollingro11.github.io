  ...
  return (
    <BlogClientWrapper>
      <div className="w-full max-w-4xl">
        <article className="mb-16 pt-8 lg:mb-32 lg:pt-20">
          <header className="mb-8">
            <Link 
              href="/blog" 
              className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 hover:underline mb-4 inline-block"
            >
              ← Back to Blog
            </Link>
            <h1 className="text-3xl sm:text-5xl font-bold mb-4 text-left">{post.title}</h1>
            {post.date && (
            ...
            <ReactMarkdown
              ...
              components={{
                ...
                figcaption: ({ children, ...props }) => (
                  <figcaption 
                    className="mt-2 text-sm sm:text-base text-gray-600 dark:text-gray-400 italic"
                    {...props}
                  >
                    {children}
                  </figcaption>
