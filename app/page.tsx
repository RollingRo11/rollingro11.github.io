...
export default function Home() {
  ...
  return (
    <div className="min-h-dvh selection:bg-gray-300 selection:text-black dark:bg-[#222129] dark:text-white dark:selection:bg-[#b6e2d3] dark:selection:text-black bg-white text-black">
      ...
      <div className="max-w-3xl mx-auto px-24 py-16 flex justify-between items-center">
        ...
        <div className="flex items-center gap-8">
          <Link
            ...
            className="text-blue-600 dark:text-[#85BAA1] hover:underline text-lg tracking-wider"
            target="_blank"
          ...
          <button
            className="text-2xl bg-transparent border-none cursor-pointer focus:outline-none font-mono"
      ...
      {/* Main content */}
      <main className="max-w-3xl mx-auto px-24 pb-20">
        {/* Intro paragraphs */}
        ...
        <section className="mb-10">
          ...
          <div className="space-y-5">
            <div>
              <h3 className="text-xl font-semibold mb-1">Mechanistic Interpretability @ NEURAI Lab</h3>
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-2">In Progress</p>
              <p className="text-xl leading-relaxed">
          ...
          <div className="space-y-4">
            <div>
              <Link
                ...
                className="text-blue-600 dark:text-[#85BAA1] hover:underline text-xl font-medium"
                target="_blank"
                rel="noopener noreferrer"
              >
